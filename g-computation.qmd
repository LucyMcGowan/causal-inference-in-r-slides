...
# {background-color="#533146" .huge .center}
...
## 2. Create a duplicate for each level of `a` 
...
## 3. Set the value of `a` to a single value for each
...
## 4. Make predictions using the model for each
...
# Continuous exposures {background-color="#533146" .huge .center} 
...
## {{<fa laptop>}} Application Excerise

::: {.nonincremental}
1. Get starter files from `https://github.com/sta-779-s25/appex-05-YOUR-GITHUB-HANDLE.git`
