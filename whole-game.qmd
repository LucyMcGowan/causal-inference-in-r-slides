...
### *Our causal effect estimate: **-13.4 (95% CI -12.5, -11.6)***
...
1. Modeled our assumptions (using propensity score weighting)
...
### Check out [Chapter 2](https://www.r-causal.org/chapters/chapter-02) of Causal Inference in R
